# -*- coding: utf-8 -*-
"""BrianSingh_Data608_Assignment2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KxoE4aediHNu491ob_nTzdGhvbK07PDH
"""
...
#saved to my desktop and loaded. File was too large to save to my github and read in
...
"""FigureWidget({
    'data': [{'type': 'scatter',
              'uid': 'beaa83b2-306c-46b5-a681-bc21e12003ad',
 …
...
ny.numfloors.max()
floor_range = [0,10, 19, 29, 39, 49, 59, 69, 79, 89, 99, 109]
ny['floor_range'] = pd.cut(ny['numfloors'],floor_range)

ny['floor_range'].value_counts()

ny.info()

import plotly.express as px

fig3 = px.histogram(ny.loc[ny.numfloors >= 10],x='yearbuilt',color='floor_range',log_y=True)

fig3.show(renderer='colab')

#I was having trouble reordering the floor ranges on the legend

"""###Question 1 Conclusion

I did have trouble reorganizing the floor_range on the legend. Nonetheless, for purposes of the visual, I removed buildings under 10 floors tall as it skewed the data and did not allow me to view it in a way to decipher what was actually occurring in terms of buildings in ranges of 20-29 floors, 30-39, and so on. In looking at the data, one can see that early on (pre-1920), buildings were dominantly on the smaller end. From 1950 onwards, there appears to have been a boom in buildings between 29-39 floors, which would make sense given the rise in financial performance of the city and the build up of Manhattan. There may be better ways to bin the data, with larger ranges to show those over 50 stories vs. those between 20-50, under 20, under 10, etc, and even further break it down using residential/commericial categories.
...
ny['bldg_land_ratio'] = ny['assessbldg']/ny['assessland']

NewYorkCity   = (( 913164.0,  1067279.0), (120966.0, 272275.0))
cvs3 = ds.Canvas(700, 700, *NewYorkCity)
agg3 = cvs3.points(ny, 'xcoord', 'ycoord',ds.count('bldg_land_ratio'))
view3 = tf.shade(agg3, cmap=cm(inferno), how='linear')
export(tf.spread(view3, px=2), 'bldgassessment')

"""###Question 2 Conclusion

I did find this question a little more challenging, even after reviewing the US Census and Pipeline examples, given the limited documentation. I calculated the building assessment by taking the total assessment less the land assessment, then the ratio of the building assessment to the land assessment. I then attempted to plot it on the NYC map using datashader, specifically, ds.count(), but I don't think this is getting me exactly where I need to be. 

Prior to this, I attempted to use ds.count_cat() to categorize the bldgclass variable and plot it this way, as well, but to map colors to each bldgclass (140+ combinations), did not seem like the right approach either.

Nonetheless, given what I did, I would say Manhattan, even moreso the upper west side, Northern Queens and SI are all overbuilt, which Brooklyn being underbuilt.
"""